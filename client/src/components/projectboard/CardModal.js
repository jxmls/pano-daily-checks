...
export default function CardModal({
  ...
  }, [open, form, checklist, comments, onClose]); // deps so latest state is saved
    ...
    <div className="fixed inset-0 z-50" role="dialog" aria-modal="true">
      ...
      <div className="absolute inset-0 overflow-y-auto">
        <div className="min-h-full flex items-start justify-center p-4">
          {/* Panel: sticky header & footer, scrollable body */}
          <div className="w-full max-w-4xl max-h-[90vh] bg-white rounded-2xl shadow-2xl border border-gray-200 flex flex-col">
            {/* Sticky header */}
